                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <?php
                            ...
                            //$selectadmin = "SELECT * FROM admin WHERE userid = $user";
                            $selectfac = "SELECT * FROM faculty";
                            $selectstu = "SELECT * FROM student";
                            $selectdept = "SELECT * FROM department";
                            $selectclass = "SELECT * FROM class";

                            //$query1 = mysqli_query($conn,$selectadmin);
                            $query2 = mysqli_query($conn,$selectfac);
                            $query3 = mysqli_query($conn,$selectstu);
                            $query4 = mysqli_query($conn,$selectdept);
                            $query5 = mysqli_query($conn,$selectclass);

                            
                            //$adminnum = mysqli_num_rows($query1);
                            $facnum = mysqli_num_rows($query2);
                            $stunum = mysqli_num_rows($query3);
                            $deptnum = mysqli_num_rows($query4);
                            $classnum = mysqli_num_rows($query5);
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                Faculties</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $facnum ?></div>
                                        </div>
                                        <div class="col-auto">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                Students</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $stunum ?></div>
                                        </div>
                                        <div class="col-auto">
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="row no-gutters align-items-center">
                                                <div class="col-auto">
                                                    <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800"><?php echo $deptnum ?></div>
                                                </div>
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                                                Classes</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $classnum ?></div>
                                        </div>
                                        <div class="col-auto">
