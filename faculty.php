      ...
      <div class="row">
        <div class="features-icons bg-light text-center col-lg-7"> 
            <div class="features-icons-item mx-auto mb-5 mb-lg-0 mb-lg-3">
                ...
                <i class="icon-user-female m-auto text-primary"></i>
                </div>
        ...
        <div class="col-lg-4 mb-lg-0">
          <div class="card card-signin mx-auto mb-lg-0 my-5">
            <div class="card-body">
              <h5 class="card-title text-center">Faculty Sign In</h5>
              <form class="form-signin" method="POST" action="data/facloginback.php">
                  <div class="form-label-group">
                  <input type="email" id="inputEmail" class="form-control" name="username1" placeholder="Email address" required autofocus>
                  ...
                  <button class="btn btn-lg btn-primary btn-block text-uppercase mb-3" name="submit1" type="submit">Sign in</button>
